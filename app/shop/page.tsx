...
export default async function Shop() {
  ...
  if (!masks.length) {
    ...
    masks[masks.length - 1] = {
      ...
      code: "",
      description:
        "Head to our masks page and browse all available mask options",
      btn_text: "View all masks",
    };
  }
  if (!fins.length) {
    fins = [];
    ...
    fins[fins.length - 1] = {
      ...
      code: "",
      description:
        "Head to our fins page and browse all available fins options",
  ...
  return (
    <div className="bg-white">
                ...
                <div>
                  <h3 className="font-bold text-gray-700">
                    <Link href={`${PAGEURL.SHOP_MASKS}/${mask.code}`}>
                      ...
                      {mask.name ? mask.name : "Browse all masks"}
                    </Link>
                  </h3>
            ...
            <div key={fin.id} className="group relative mb-5">
              <div className="min-h-80 aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-md bg-gray-200  lg:aspect-none lg:h-80">
                <Link href={`${PAGEURL.SHOP_FINS}/${fin.code}`}>
                  <img
                    src={getImageSrc(
                      fin.name ? fin.name : "all-starter-fins",
                      null,
                      "fins"
                    )}
                    alt={fin.description}
              ...
              <div className="mt-4 flex justify-between">
                <div>
                  <h3 className="text-gray-700 font-bold">
                    <Link href={`${PAGEURL.SHOP_FINS}/${fin.code}`}>
                      <span aria-hidden="true" className="" />
                      {fin.name ? fin.name : "Browse all fins"}
                    </Link>
                  </h3>
      ...
      <div className="mx-auto max-w-2xl px-4 sm:py-6 sm:px-6 lg:max-w-7xl lg:px-8 hidden">
        <h2 className="text-2xl font-bold tracking-tight text-gray-900">
          Diving Accessories
        </h2>
        <blockquote className="text-sm italic font-semibold text-gray-900 mt-4 flex items-center">
          ...
          <p>Your dive and travel buddies</p>
        </blockquote>
      </div>
      <div className="mx-auto max-w-2xl px-4 sm:py-6 sm:px-6 lg:max-w-7xl lg:px-8 hidden">
